...
const youtube = new YouTube("TOKEN_YTURL");
...
function play(guild, song) {
	...
	const dispatcher = serverQueue.connection.playStream(ytdl(song.url))
		.on('end', reason => {
			if (reason === 'Stream is not generating quickly enough.') console.log('Som acabado.');
...
client.login('NTA2MTUwMTAzNTM5NTE1NDAy.XNb45A.owyPwuDhPVip0cvVLC8nqkmOQtc');